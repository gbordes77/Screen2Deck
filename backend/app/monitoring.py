...
cache_hit_rate = Gauge("cache_hit_rate", "Cache hit rate percentage", registry=registry)

active_jobs = Gauge("active_jobs", "Number of active OCR jobs", registry=registry)
...
redis_connections = Gauge(
    "redis_connections", "Number of Redis connections", registry=registry
)
...
def track_ocr_stage(stage: str, duration: float):
    ...
    ocr_processing_duration_seconds.labels(stage=stage).observe(
        duration / 1000
...
def update_cache_hit_rate():
    ...
    try:
        ...
        misses = cache_operations_total.labels(
    ...
    try:
        ...
        health = {
            ...
            "metrics": {
                ...
                "active_jobs": (
                    active_jobs._value.get() if hasattr(active_jobs, "_value") else 0
                ),
            },
        }
